...
Public Function FillColorSetList()
   Dim rsColorSets As Recordset, i As Integer, showAll As Integer
   ...
   Else '++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ Have Expression Dataset
      ...
      If Not rsColorSets.EOF Then '=======================================Have Color Sets Available
         With lstColorSets '--------------------------------------------------Set Up Color Set List
            .Clear
            ...
            Loop
            For i = 1 To colorIndexes(0) '.................................Show Color Sets Selected
               lstColorSets.selected(colorIndexes(i) + 1 + showAll) = True
                                               'No expression data first and showall might be there
            Next i
         End With
      End If
   End If
...
Private Sub cmdColorSetsDown_Click()
   ...
   lstColorSets.ToolTipText = "Hold Ctrl to choose multiple color sets. OK when done."
   txtColorSets = "Choose Color Sets"
   DoEvents
End Sub
      ...
      Else '====================================================================At Least One Chosen
         ...
         Else '----------------------------------------------------------Selection Process Finished
            ...
            If colorIndexes(0) = 1 Then '...................................Assign Single Color Set
               Set rs = dbExpression.OpenRecordset("SELECT ColorSet FROM ColorSet WHERE SetNo = " & colorIndexes(1))
