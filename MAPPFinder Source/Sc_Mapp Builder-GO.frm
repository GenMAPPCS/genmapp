...
Begin VB.Form MappBuilderForm_Sc 
   AutoRedraw      =   -1  'True
   BackColor       =   &H00C0FFFF&
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.TextBox txtNotes 
         ...
         TabIndex        =   8
         Text            =   "Sc_Mapp Builder-GO.frx":0000
         Top             =   2160
         Width           =   5055
      End
   ...
   End
End
Attribute VB_Name = "MappBuilderForm_Sc"
...
Public Sub MakeMapps_Click() 'Make MAPPs
   ...
   fsys.CopyFile mapptmpl_sc, MappPath, True
   ...
   '                                correct MAPP file
        If currentMAPP = MAPPFileName Then
            ...
            If centerY > (STARTY + (GENEHEIGHT * MAXGENE)) Then 'columns of MAXGENE
                ...
                centerY = STARTY
            End If
            If primaryType = "D" Or primaryType = "d" Then
               labelbool = False
